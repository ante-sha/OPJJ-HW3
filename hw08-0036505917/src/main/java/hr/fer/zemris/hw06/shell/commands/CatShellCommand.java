...
public class CatShellCommand implements ShellCommand {
	...
	static {
		description = Collections.unmodifiableList(Arrays.asList("Print files on the screen", "First argument is path to the file",
	...
	private void run(Environment env, String arguments) throws IOException {
		...
		Path path = CommandUtil.returnNormalizedPath(params.get(0), env);
