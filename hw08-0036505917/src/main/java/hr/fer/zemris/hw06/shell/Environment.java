...
public interface Environment {
	...
	/**
	 * Metoda koja postavlja simbol kojeg je potrebno pisati na kraju retka ako se
	 * želi napisati naredbu kroz više redaka
	 * 
	 * @param symbol novi simbol
	 */
	...
	/**
	 * Metoda za dohvat direktorija na temelju kojeg se razrješavaju relativne
	 * staze.
	 * 
	 * @return normalizirana staza do direktorija
	 */
	Path getCurrentDirectory();

	/**
	 * Metoda koja postavlja direktorij na temelju kojeg se razrješuju sve relativne
	 * staze predane u argumentu.
	 * 
	 * @param path staza do direktorija
	 */
	void setCurrentDirectory(Path path);

	/**
	 * Metoda za dohvat dijeljenih podataka među naredbama. Svaki podatak se dohvaća
	 * preko svog ključa.
	 * 
	 * @param key ključ podatka
	 * @return dijeljeni podatak
	 */
	Object getSharedData(String key);

	/**
	 * Ubacivanje dijeljenih podataka u okolinu.
	 * 
	 * @param key   ključ
	 * @param value dijeljeni podatak
	 */
