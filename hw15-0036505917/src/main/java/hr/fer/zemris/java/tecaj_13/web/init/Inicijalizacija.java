...
/**
 * Promatrač za inicijalizaciju i spremanje objekta za kreiranje veza s bazom
 * podataka EntityManagerFactory kojeg se sprema u parametre aplikacije pod
 * imenom "my.application.emf". <br>
 * Prije gašenja aplikacije taj objekt se zatvara.
 * 
