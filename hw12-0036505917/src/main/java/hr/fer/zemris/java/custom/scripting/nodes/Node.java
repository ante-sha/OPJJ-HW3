...
/**
 * Razred koji modelira čvor kojeg generira {@link SmartScriptParser}
 * grupiranjem elemenata {@link Element}. Svaki čvor može imati svoje
 * "podčvorove"(tzv. djecu) kao što nalaže strukturiranje parsera.
 * 
...
public abstract class Node {
	...
	private List<Node> djeca = new ArrayList<>();
	...
	/**
	 * Metoda koja poziva odgovarajuću metodu visitora i predaje mu svoju
	 * referencu
	 * 
	 * @param visitor
	 */
	...
	/**
	 * <p>
	 * Metoda koja provjerava da li je čvor jednak objektu obj, ako se radi o
	 * referenci na drugi čvor tada se provjerava da li su im djeca jednaka. Ako se
	 * pojavi primjer više razina grananja metoda pozivanja jednakosti djece će se
	 * rekurzivno spustiti u sve grane stabla.
	 * 
	 * @return true - ako su im jednaka djeca <br>
	 *         false - ako obj nije primjerak čvora ili im sva djeca nisu jednaka
	 *         </p>
	 */
	@Override
